...
public abstract class AbstractProgressMonitor implements ProgressMonitor {
    ...
    public void addCancelListener(CancelListener listener) {
        cancelHandler.addCancelListener((org.openstreetmap.josm.gui.progress.ProgressMonitor.CancelListener) listener);
    }

    @Override
    public void removeCancelListener(CancelListener listener) {
        cancelHandler.removeCancelListener((org.openstreetmap.josm.gui.progress.ProgressMonitor.CancelListener) listener);
    }
