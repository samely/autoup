        ...
        jchb1 = new JCheckBox(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (jchb1.isSelected()) {
                    ...
                    StrategySpecification strategy = new StrategySpecification();
                    ChangesetPlugin cp = new ChangesetPlugin();
                    APIDataSet apiData = new APIDataSet(Main.main.getCurrentDataSet());
                    UploadPrimitivesTask pt = new UploadPrimitivesTask(strategy.getUploadStrategySpecification(),
